...
ALTER TABLE OPCOMCAMERA DROP CONSTRAINT FK2_OPCOMCAMERA;
ALTER TABLE OPCOMCAMERA ADD CONSTRAINT FK2_OPCOMCAMERA
                FOREIGN KEY(CAMERA)
                REFERENCES CAMERA
                ON DELETE CASCADE; /* RESTRICT -> CASCADE */

ALTER TABLE OPCOMCAMERA DROP CONSTRAINT FK1_OPCOMCAMERA;
ALTER TABLE OPCOMCAMERA ADD CONSTRAINT FK1_OPCOMCAMERA
